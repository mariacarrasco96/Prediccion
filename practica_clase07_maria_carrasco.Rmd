---
title: "Practica_clase07_maria_carrasco_melendez"
output:
  pdf_document:
...
```{r}
series <- c('NAEXKP01GBQ657S', 'GBRCPIALLQINMEI') # FRED codes for US GDP growth and CPI
...
pivot_longer(Data, cols=-Date, names_to="Variables", values_to="Values") %>% 
  ...
  labs(title="UK GDP growth and CPI inflation", x="", y="",
